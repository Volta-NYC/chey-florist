          ...
          <div>
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="first-name" className="block text-sm font-medium text-ink/80 mb-1">First Name</label>
                  <input type="text" id="first-name" className="w-full border-ink/25 border p-3 focus:ring-black focus:border-black" />
                </div>
                <div>
                  <label htmlFor="last-name" className="block text-sm font-medium text-ink/80 mb-1">Last Name</label>
                  <input type="text" id="last-name" className="w-full border-ink/25 border p-3 focus:ring-black focus:border-black" />
                </div>
              </div>
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-ink/80 mb-1">Email</label>
                <input type="email" id="email" className="w-full border-ink/25 border p-3 focus:ring-black focus:border-black" />
              </div>
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-ink/80 mb-1">Message</label>
                <textarea id="message" rows={6} className="w-full border-ink/25 border p-3 focus:ring-black focus:border-black"></textarea>
              </div>
          ...
          <div className="bg-stone-50 p-8 md:p-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-ink/70">123 Floral Lane<br />Garden District, NY 10001</p>
              </div>
              
              <div>
                <h3 className="font-semibold text-sm uppercase tracking-wider mb-2">Hours</h3>
                <p className="text-ink/70">Monday - Friday: 9:00 AM - 6:00 PM<br />Saturday: 10:00 AM - 4:00 PM<br />Sunday: Closed</p>
              </div>
